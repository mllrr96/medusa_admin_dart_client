...
part of '../../../../../../src/data/models/store_models/store/line_item.dart';
...
abstract class _$LineItemCWProxy {
  ...
  LineItem rawDiscountTotal(int? rawDiscountTotal);
  ...
  LineItem unitPrice(int? unitPrice);
...
class _$LineItemCWProxyImpl implements _$LineItemCWProxy {
  ...
  @override
  LineItem unitPrice(int? unitPrice) => this(unitPrice: unitPrice);
