...
part of '../../../../../../src/data/models/store_models/store/discount_condition.dart';
...
abstract class _$DiscountConditionCWProxy {
  ...
  DiscountCondition type(DiscountConditionType? type);

  DiscountCondition operator(DiscountConditionOperator? operator);
  ...
  DiscountCondition createdAt(DateTime? createdAt);

  DiscountCondition updatedAt(DateTime? updatedAt);

  DiscountCondition deletedAt(DateTime? deletedAt);
...
class _$DiscountConditionCWProxyImpl implements _$DiscountConditionCWProxy {
  ...
  @override
  DiscountCondition type(DiscountConditionType? type) => this(type: type);
  ...
  DiscountCondition call({
    ...
    return DiscountCondition(
      ...
      type: type == const $CopyWithPlaceholder()
          ? _value.type
          // ignore: cast_nullable_to_non_nullable
          : type as DiscountConditionType?,
      operator: operator == const $CopyWithPlaceholder()
          ? _value.operator
          // ignore: cast_nullable_to_non_nullable
          : operator as DiscountConditionOperator?,
