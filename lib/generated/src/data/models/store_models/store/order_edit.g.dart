...
part of '../../../../../../src/data/models/store_models/store/order_edit.dart';
...
abstract class _$OrderEditCWProxy {
  ...
  OrderEdit changes(List<OrderItemChange>? changes);
...
class _$OrderEditCWProxyImpl implements _$OrderEditCWProxy {
  ...
  @override
  OrderEdit changes(List<OrderItemChange>? changes) => this(changes: changes);
  ...
  OrderEdit call({
    ...
    return OrderEdit(
      ...
      changes: changes == const $CopyWithPlaceholder()
          ? _value.changes
          // ignore: cast_nullable_to_non_nullable
          : changes as List<OrderItemChange>?,
