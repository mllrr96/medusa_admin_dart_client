...
part of '../../../../../../src/data/models/store_models/store/discount.dart';
...
abstract class _$DiscountCWProxy {
  ...
  Discount startsAt(DateTime? startsAt);

  Discount endsAt(DateTime? endsAt);
  ...
  Discount deletedAt(DateTime? deletedAt);
...
class _$DiscountCWProxyImpl implements _$DiscountCWProxy {
  ...
  @override
  Discount startsAt(DateTime? startsAt) => this(startsAt: startsAt);

  @override
  Discount endsAt(DateTime? endsAt) => this(endsAt: endsAt);
  ...
  @override
  Discount deletedAt(DateTime? deletedAt) => this(deletedAt: deletedAt);
  ...
  Discount call({
    ...
    return Discount(
      ...
      usageLimit: usageLimit == const $CopyWithPlaceholder()
          ...
          : usageLimit as int?,
      usageCount:
          usageCount == const $CopyWithPlaceholder() || usageCount == null
              ? _value.usageCount
              // ignore: cast_nullable_to_non_nullable
              : usageCount as int,
