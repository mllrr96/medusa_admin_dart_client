...
class UserStoreRetrievePaymentProvidersRes {
  ...
  factory UserStoreRetrievePaymentProvidersRes.fromJson(
      Map<String, dynamic> json) {
    List<PaymentProvider> paymentProviders = [];
    if (json['payment_providers'] != null) {
      json['payment_providers']
          .forEach((v) => paymentProviders.add(PaymentProvider.fromJson(v)));
    }
    return UserStoreRetrievePaymentProvidersRes(
        paymentProviders: paymentProviders.isEmpty ? null : paymentProviders);
  }
}
...
class UserStoreRetrieveTaxProvidersRes {
  ...
  factory UserStoreRetrieveTaxProvidersRes.fromJson(Map<String, dynamic> json) {
    ...
    if (json['tax_providers'] != null) {
      json['tax_providers']
          .forEach((v) => taxProviders.add(TaxProvider.fromJson(v)));
    }
    return UserStoreRetrieveTaxProvidersRes(
        taxProviders: taxProviders.isEmpty ? null : taxProviders);
  }
}
