...
part '../../../../../generated/src/data/models/store_models/store/discount_condition_product_collection.g.dart';
...
class DiscountConditionProductCollection {
 ...
 factory DiscountConditionProductCollection.fromJson(Map<String, dynamic> json) {
   return DiscountConditionProductCollection(
     productCollectionId: json['product_collection_id'],
     conditionId: json['condition_id'],
     productCollection: json['product_collection'] != null ? ProductCollection.fromJson(json['product_collection']) : null,
     discountCondition: json['discount_condition'] != null ? DiscountCondition.fromJson(json['discount_condition']) : null,
